...
// ? safer than any
let y: unknown = "Bakery";
if (typeof y === "number") console.log(y + 10);
if (typeof y === "string") console.log(y.length);
const y_: unknown = 100;
if (typeof y_ === "number") console.log(y_ + 78);
if (typeof y_ === "string") console.log(y_);
...
// ? Any
function processFeedback_0(input: any): void {
...
// ? Unknown
function processFeedback_1(input: unknown = "Apple"): void {
    // ? we can identify the unknown type of value using typeof method
    if (typeof input === "string") console.log(`Processing text: ${input}`);
    else if (typeof input === "number") console.log(`Processing rating: ${input}`);
    else if (typeof input === "number") console.log(`Processing rating: ${input}`);
    else if (input instanceof Blob) console.log(`Processing file :`);
    else console.log('Unsupported type of input');
...
const _: unknown = 11
const outputa = (_ as string) + (100 as number)
console.log(outputa);
